...
{
    public class OrderServices(IOrderRepository orderRepository, IProductRepository productRepository, IProductServices productServices) : IOrderServices
    {
        ...
        public async Task<List<OrderDto>> GetAllOrders()
        {
            ...
            rta = [..(from order in orders
                   join product in allProducts on order.ProductId.ToUpper().Trim() equals product.Id.ToUpper().Trim()
